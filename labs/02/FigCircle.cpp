...
*/
REGISTER_METHOD_WITH_CHECK_RET_PTR(CreateFigureFileMarkFuncArray, CreateFigCircle, GetRegMarkFigCircle(), "Registration of CreateFigCircleUseFileMark", 3, Figure); 
...
*/
REGISTER_METHOD(OutFigureFuncArray, OutFigCircle, GetRegMarkFigCircle(), 
"Registration of OutFigCircle");
