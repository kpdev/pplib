...
*/
CREATE_REG_MARK_METHOD(FigColorDecorator);
REGISTER_SPECIALIZATION(Figure, FigColorDecorator, "Registration of: FigColorDecorator");
...
REGISTER_METHOD_WITH_CHECK_RET_PTR(CreateFigureFileMarkFuncArray, CreateFigColorDecorator, GetRegMarkFigColorDecorator(), "Registration of CreateFigColorDecoratorUseFileMark", 13, Figure); 
...
*/
REGISTER_METHOD(InFigureValueFuncArray, InFigColorDecoratorValue, GetRegMarkFigColorDecorator(), "Registration of InFigColorDecoratorValue");
...
*/
REGISTER_METHOD(OutFigureFuncArray, OutFigColorDecorator, GetRegMarkFigColorDecorator(), 
"Registration of OutFigColorDecorator");
...
*/
REGISTER_METHOD(DeleteFigureFuncArray, DeleteFigColorDecoratorSkin, GetRegMarkFigColorDecorator(), "Registration of DeleteFigColorDecoratorSkin");
